...
import com.sem5.java_proj.model.Basket;
...
public class OrderController {
	...
	private OrderController() {
		...
		productsQuantity.add(1);
		productsQuantity.add(1);
		productsQuantity.add(1);	productsQuantity.add(1);
		...
		productsPrice.add(0d);
		productsPrice.add(0d);
		productsPrice.add(0d);productsPrice.add(0d);productsPrice.add(0d);productsPrice.add(0d);
